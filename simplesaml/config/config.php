...
//BEGIN: enable debugging as requested by ACQUIA
$config['debug'] = true;
$config['logging.level'] = SimpleSAML_Logger::DEBUG;
//END: enable debugging as requested by ACQUIA

//BEGIN: modification for https via ACQUIA
...
//END: modification for https via acquia
...
$config['technicalcontact_email'] = "administrator@sec.gov";
// Change these for your installation
$config['secretsalt'] = 'y0h9d13pki9qdhfm3l5nws4jjn55j6hj';
$config['auth.adminpassword'] = 'HGNHz87Q9x8J7LkS';
...
if(!function_exists("acquia_session_store_config") ) {
  ...
  if (empty($_ENV['AH_SITE_ENVIRONMENT'])) {
    ...
    $db_name = $ah_options['database_name'];
    ...
    $db_cluster_id = $creds['db_cluster_id'];
    ...
    try {
      ...
      $cached_id = key($db['db_url_ha']);
    }
    $creds['host'] = $cached_id;
