...
namespace Drupal\Tests\content_moderation_state_relationship\Kernel;
...
class ViewsDataIntegrationTest extends ViewsKernelTestBase {
  ...
  public static $modules = [
    'content_moderation_state_relationship_test_views',
    'content_moderation',
    'content_moderation_state_relationship',
    'node',
    'workflows',
    'entity_test',
  ];
  ...
  protected function setUp($import_test_views = TRUE) {
    ...
    $this->installConfig('content_moderation_state_relationship_test_views');
  }
