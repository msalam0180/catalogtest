 ...
 * @endcode
 */
$settings['hash_salt'] = 'ACMECATALOGAACMECATALOGAACMECATALOGA';
...
if (file_exists('/var/www/site-php/datacatalog01/')) {
  require('/var/www/site-php/datacatalog01/datacatalog01-settings.inc');
} else if (file_exists('/var/www/site-php/acmecatalogb/')) {
  require('/var/www/site-php/acmecatalogb/acmecatalogb-settings.inc');
}
